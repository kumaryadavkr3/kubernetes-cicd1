pipeline {
    ...
    environment {
        ...
        GKE_CLUSTER_NAME = 'k8s-cluster' // Update with your GKE cluster name
        GKE_PROJECT_ID = 'cool-ocean-449307-h8' // Update with your GCP project ID
        GKE_ZONE = 'us-central1' // Update with your GKE cluster zone
        GIT_REPO_URL = 'https://github.com/kumaryadavkr3/kubernetes-cicd1.git' // Update with your Git repository URL
